...
;(read-raw-response
;  @(http/get "https://finance.yahoo.com/quote/AAPL/history"
;             {"Connection" "keep-alive"
;              "Expires" "-1"
;              "Upgrade-Insecure-Requests" "1"
;              "User-Agent" "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.99 Safari/537.36"}) :body)
...
(defn refresh-fx-data! [] (reset! fx-data (get-last-price static/list-fx)))
(defn refresh-commodities-data! [] (reset! commodities-data (get-last-price static/list-commodities)))
